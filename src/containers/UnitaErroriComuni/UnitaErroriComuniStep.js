...
export default class UnitaErroriComuniStep extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  render() {
    const {
      totaleDomande,
      step,
    ...
    return (
      <FlexWrap>
        <EsecuzioneSteps
          ...
          helpButtonFunction={helpButtonFunction}
          correzioneRisposta={{
            isCheckable,
            isChecked,
            isPristine,
...
UnitaErroriComuniStep.propTypes = {
  ...
  helpButtonFunction: PropTypes.func.isRequired,
};
